    ...
    <footer className="font-sans text-white">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-10 md:gap-12">
          ...
          <div className="md:col-span-5 space-y-6">
            <div className="flex flex-col items-start gap-4">
              ...
              <div className="flex items-center gap-4 group cursor-default">
                ...
                {/* Border line between logo and text */}
              ...
              <p className="text-white/60 text-sm md:text-base leading-relaxed max-w-sm">
                Create · Connect · Inspire. We help brands grow beyond
                boundaries with smart digital marketing.
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-4 text-white/70 text-sm font-medium">
              ...
              <li>
                <Link href="/portfolio" className="hover:text-[#f97316] transition-colors">Portfolio</Link>
              </li>
              <li>
      ...
      <div className="bg-[#0a422a] py-6 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-white/40 text-[12px] md:text-sm font-medium">
          ...
          <p className="flex items-center gap-1 uppercase tracking-widest text-[10px]">A Digital Venture of Sajib BD</p>
        </div>
      </div>

      <style jsx>{`
        .social-btn {
          @apply w-10 h-10 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-white/60 hover:bg-[#f97316] hover:text-white hover:border-[#f97316] transition-all duration-300;
        }
      `}</style>
    </footer>
  );
