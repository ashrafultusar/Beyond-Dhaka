    ...
    <div className="w-full">
      ...
      {showSeeMoreBtn && (
        <div className="flex justify-center mt-10 md:mt-16">
          <Link href="/portfolio">
            <button className="group flex items-center gap-2 md:gap-3 px-6 md:px-8 py-3 md:py-4 bg-transparent text-[#11502e] text-[13px] md:text-[15px] font-bold border-2 border-[#11502e]/10 rounded-full hover:bg-[#11502e] hover:text-white transition-all duration-300 cursor-pointer">
              Explore All Projects
              <ArrowRight
                size={18}
                className="text-[#f97316] group-hover:translate-x-1 transition-transform"
              />
            </button>
          </Link>
        </div>
