...
const ServiceCard: React.FC<ServiceCardProps> = ({ icon, title, description }) => {
  return (
    <div className="group relative bg-white rounded-[24px] p-8 border border-[#e5f1e8]/70 hover:border-[#f97316]/30 hover:shadow-[0_20px_50px_rgba(249,115,22,0.1)] transition-all duration-500 overflow-hidden min-h-[320px] flex flex-col justify-between">
      ...
      <div className="relative z-10">
        ...
        <div className="w-[64px] h-[64px] rounded-[16px] bg-[#11502e] flex items-center justify-center mb-10 group-hover:bg-[#f97316] group-hover:rotate-[8deg] transition-all duration-500 shadow-sm">
          {React.isValidElement(icon) ? (
            // এখানে <any> এর বদলে <IconProps> ব্যবহার করা হয়েছে
